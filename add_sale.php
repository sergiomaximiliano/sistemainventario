...
if (isset($_POST['add_sale'])) {
  ...
  if (empty($errors)) {
    ...
    $s_profit  = $db->escape($_POST['profit']);
    $s_date    = date("Y-m-d", strtotime($date));

    $sql  = "INSERT INTO sales (";
    $sql .= " product_id,qty,price,date, profit";
    $sql .= ") VALUES (";
    $sql .= "'{$p_id}','{$s_qty}','{$s_total}','{$s_date}','{$s_profit}'";
    $sql .= ")";
...
<div class="row">
  ...
  <div class="col-md-6">
    <a href="new_sale.php" class="btn btn-primary hide">Agregar venta</a>
  </div>
</div>
<div class="row">
